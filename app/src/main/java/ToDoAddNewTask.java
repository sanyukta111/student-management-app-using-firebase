...
public class ToDoAddNewTask extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_to_do_add_new_task, container, false);
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        if(activity instanceof ToDoOnDialogCloseListner){
            ((ToDoOnDialogCloseListner)activity).onDialogClose(dialog);
        }
