...
public class addMod extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(addMod.this,newMod.class));
            }
        });

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("assign");
    ...
    private void uploadPDFFile(Uri data)
    {
        ...
        StorageReference reference = storageReference.child("assign/"+System.currentTimeMillis()+".pdf");
